...
<div class="min-h-screen bg-bg flex">
	<aside class="w-56 border-r border-border flex flex-col select-none">
		<!-- Nav -->
		<nav class="flex-1 p-2 pt-3 space-y-0.5 overflow-y-auto">
			<!-- Overview + Search -->
			<a
				href="/app/overview"
				class="flex items-center gap-2 px-2.5 py-1.5 rounded-lg text-sm transition-all {page.url.pathname === '/app/overview' ? 'bg-surface text-text' : 'text-text-secondary hover:bg-surface/50 hover:text-text'}"
			>
			...
			>
				...
				<kbd class="text-[9px] text-text-muted bg-surface border border-border rounded px-1 py-0.5 font-mono">⌘K</kbd>
			</button>
						...
						<div class="group relative pl-4">
							...
							<div class="flex items-center">
								...
								<button
									...
									class="w-5 h-5 flex items-center justify-center text-text-muted hover:text-danger rounded opacity-0 group-hover:opacity-100 transition-opacity"
									title="delete"
								>
